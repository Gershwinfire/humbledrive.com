...
def get_hangseng_price():
    ##Set the url for which we will be scraping data from
    url = "https://www.marketwatch.com/investing/index/hsi?countrycode=hk"
    ...
    hangseng_data = json.loads(data)
    hangseng_price = hangseng_data["price"]

    return hangseng_price
